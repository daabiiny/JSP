...
<script>
	...
	const replyBtnHandler = function() {
		...
		form.querySelector('testarea').focus()
	}
...
<script>
	// 1) 문서 전체에서 a태그 중에서 클래스가 deleteBtn인 모든 요소를 nodeList형태로 불러온다
